...
namespace Joint
{
    public static class Extensions
    {
        ...
        public static TModel GetOptions<TModel>(this IJointBuilder builder, string settingsSectionName)
            where TModel : new()
        {
        ...
        [Obsolete("Call 'UseJoint()' instead, this method might be removed in the future.")]
