...
{
    internal sealed class JointLoggingScopeHttpMessageHandler : DelegatingHandler
    {
        private readonly ILogger _logger;
        private readonly HashSet<string> _maskedRequestUrlParts;
        private readonly string _maskTemplate;

        public JointLoggingScopeHttpMessageHandler(ILogger logger, HttpClientOptions options)
        {
