using System;
using SCL.Docs.Swagger.Builders;
using Microsoft.AspNetCore.Builder;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.OpenApi.Models;

namespace SCL.Docs.Swagger
{
    public static class Extensions
    {
        ...
        public static ISCLBuilder AddSwaggerDocs(this ISCLBuilder builder, string sectionName = SectionName)
        {
        ...
        public static ISCLBuilder AddSwaggerDocs(this ISCLBuilder builder, SwaggerOptions options)
        {
