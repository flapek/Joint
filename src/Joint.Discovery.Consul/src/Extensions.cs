...
using Joint.Discovery.Consul.Builders;
using Joint.Discovery.Consul.Http;
using Joint.Discovery.Consul.MessageHandlers;
using Joint.Discovery.Consul.Models;
using Joint.Discovery.Consul.Services;
using Joint.HTTP;
...
namespace Joint.Discovery.Consul
{
    public static class Extensions
    {
        ...
        public static IJointBuilder AddConsul(this IJointBuilder builder, string sectionName = SectionName,
        ...
        public static IJointBuilder AddConsul(this IJointBuilder builder,
        ...
        public static IJointBuilder AddConsul(this IJointBuilder builder, ConsulOptions options,
        ...
        public static void AddConsulHttpClient(this IJointBuilder builder, string clientName, string serviceName)
        ...
        private static ServiceRegistration CreateConsulAgentRegistration(this IJointBuilder builder,
